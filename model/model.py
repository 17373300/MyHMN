...
class HMN(nn.Module):
    ...
    def RSABlock(self, text_embedding, text_lens, law_repeat, law_len):
        ...
        avg_alpha, avg_beta, M = self.AoALayer.forward(text_embedding, text_lens,
                                                    law_repeat, law_len)
    ...
    def encoder(self, text):
        ...
        for t in text:
            ...
            t = torch.cat(
                (t, torch.zeros((1, max_seg - seq_len, self.hidden_dim)).cuda()),
                dim=1)
            # (1,L,H) -> (B,L,H)
    ...
    def forward(self, text, text_lens, law):
        ...
        output_feature, M = self.RSABlock(text_embedding, text_lens, law_repeat,
                                       law_len)
